...
짧은 예시:
입력: 이 문서는 나중에 다시 확인하는 것이 좋겠죠.
출력: 이 문서는 나중에 다시 확인하는 것이 좋다.
입력: 아, 물론 지금 바로 처리할 필요는 없어요.
출력: 지금 바로 처리할 필요는 없다.
입력: 누군가에 의해 옮겨진 듯한 상자가 존재합니다.
출력: 누군가 옮긴 듯한 상자가 있다.
입력: 그런 흐름을 보고 다음 행동을 정하면 되는 걸까요?
출력: 그런 흐름을 보고 다음 행동을 정하면 된다.
입력: 창가에 놓여 있거나, 책상 위에 놓여 있거나. 아니, 반드시 그 둘 중 하나는 아니겠지만요.
출력: 창가나 책상 위에 놓여 있을 수 있다. 다만 반드시 그 둘 중 하나라고 단정할 수는 없다.
